...
Interactive primitives and iconography use the MIT-licensed `@headlessui/react`
and `@heroicons/react` npm packages — normal dependencies of
`app-template/package.json`, not vendored code.
